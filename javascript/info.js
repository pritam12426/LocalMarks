...
function renderCategoryChart(categories) {
	...
	// Build with a fragment — one DOM write
...
function renderTagCloud(tagHash) {
	...
	function render() {
		...
		// Build cloud items with a fragment — attach handlers while building
		const frag  = document.createDocumentFragment();
...
function renderDomainGrid(domainHash) {
	...
	// Build cards with a fragment + attach handlers while building (no second query pass)
	const frag = document.createDocumentFragment();
