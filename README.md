...
│   └── info_page.png
├── javascript/
│   ├── main.js            # Entry point, hash router, theme/layout/sidebar init
...
| File                          | Purpose                                                                                          |
| ----------------------------- | ------------------------------------------------------------------------------------------------ |
| `javascript/main.js`          | Entry point; bootstraps data, registers hash router, theme/layout/sidebar init                   |
